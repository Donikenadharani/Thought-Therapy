...
app = Flask(__name__)
CORS(app)
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+mysqlconnector://root:Dharani6122@localhost:3306/mind_therapy'
...
app.route
Depression_model_path = os.path.abspath('C:\\Users\\DHARANI\\OneDrive\\Desktop\\Project\\thought-therapy-main\\thought-therapy-main\\backend\\models\\Depression_svm_model.pkl')
...
anxiety_model_path = os.path.abspath('C:\\Users\\DHARANI\\OneDrive\\Desktop\\Project\\thought-therapy-main\\thought-therapy-main\\backend\\models\\anxiety_svm_model.pkl')
...
stress_model_path = os.path.abspath('C:\\Users\\DHARANI\\OneDrive\\Desktop\\Project\\thought-therapy-main\\thought-therapy-main\\backend\\models\\stress_svm_model.pkl')
